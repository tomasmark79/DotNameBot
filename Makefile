...
.PHONY: help build debug build-clang debug-clang all everything test test-verbose clean clean-packages dev format check doxygen \
	...
	install nix-build pin-shells package-native package-aarch64 package-windows package-wasm package-all packages bundle-aarch64-deps \
...
# Default target
help:
	@echo "DotNameBot - Available targets:"
	@echo ""
	...
	@echo "  make nix-build      - Build Nix package (nix build ./nix#DotNameBot)"
...
all: build cross-all
	...
	@echo "  Native:  ./build/builddir-release/DotNameBot"
	@echo "  ARM64:   ./build/builddir-aarch64-release/DotNameBot"
	@echo "  Windows: ./build/builddir-windows-release/DotNameBot.exe"
	@echo "  WASM:    ./build/builddir-wasm-release/DotNameBot.js"

# Build all variants (native gcc/clang + cross)
everything: build debug build-clang debug-clang cross-all
	@echo ""
	@echo "✓ All variants built successfully!"
	@echo "  Native GCC release: ./build/builddir-release/DotNameBot"
	@echo "  Native GCC debug:   ./build/builddir-debug/DotNameBot"
	@echo "  Native Clang release: ./build/builddir-release-clang/DotNameBot"
	@echo "  Native Clang debug:   ./build/builddir-debug-clang/DotNameBot"
	@echo "  ARM64:   ./build/builddir-aarch64-release/DotNameBot"
	@echo "  Windows: ./build/builddir-windows-release/DotNameBot.exe"
	@echo "  WASM:    ./build/builddir-wasm-release/DotNameBot.js"
